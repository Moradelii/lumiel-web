...
export const SERVICE_DIVISIONS: ServiceDivision[] = [
  {
    ...
    subtitle: {
      es: 'Legalización internacional de documentos (Regular 2-3 semanas $150 | Rápido 1 sem $550 | Express 24h $700 | Traducción +$120)',
      en: 'International document authentication (Regular 2-3 wks $150 | Fast 1 wk $550 | Express 24h $700 | Translation +$120)',
    },
    description: {
      es: 'Asistencia profesional para documentos que requieren apostilla conforme al Convenio de La Haya. Tiempo regular de 2 a 3 semanas ($150), trámite rápido en 1 semana ($550), express en 24 horas ($700) y traducción opcional (+ $120). Aplica para todos los servicios de apostillado.',
      en: 'Professional assistance for documents requiring Hague Apostille certification. Standard processing 2 to 3 weeks ($150), fast-track in 1 week ($550), express in 24 hours ($700) and optional translation (+ $120). Applies to all apostille services.',
    },
    iconName: 'Stamp',
    services: [
      {
        ...
        shortDesc: {
          es: 'Apostilla oficial para actas de nacimiento emitidas en Texas u otros estados. Trámite regular 2 a 3 semanas ($150), rápido ($550) o express 24h ($700).',
          en: 'Official apostille certification for state-issued birth certificates. Standard 2 to 3 weeks ($150), fast ($550) or express 24h ($700).',
        },
        fullDesc: {
          es: 'Gestión completa ante la Secretaría de Estado (Texas Secretary of State o entidad estatal correspondiente). Verificamos que el documento cuente con el sello original y firma de la autoridad facultada. Procesamiento regular en 2 a 3 semanas ($150), rápido en 1 semana ($550) o express en 24 horas ($700). Traducción certificada + $120.',
          en: 'Complete handling with the Secretary of State. We verify certified vital records contain required state registrar signatures before apostille submission. Standard 2-3 weeks ($150), fast 1 week ($550) or express 24 hours ($700). Certified translation + $120.',
        },
        requirements: {
          es: ['Documento original indispensable en físico (no copias ni fotos)', 'Copia certificada emitida por Registro Civil / Vital Statistics', 'Identificación oficial del solicitante', 'País de destino del trámite'],
          en: ['Physical original document strictly required', 'State certified copy from Department of State Health Services', 'Government issued photo ID', 'Destination country of use'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
        popular: true,
      ...
      },
      {
        ...
        shortDesc: {
          es: 'Legalización internacional de actas de matrimonio para registros consulares y ciudadanía. Regular 2 a 3 sem ($150).',
          en: 'International legalization of marriage certificates for dual citizenship and foreign registries.',
        },
        fullDesc: {
          es: 'Trámite especializado para actas de matrimonio otorgadas en cualquier condado o estado. Ideal para convalidaciones de matrimonio en consulados y trámites de residencia. Tiempo regular: 2 a 3 semanas ($150), rápido 1 semana ($550), express 24h ($700), traducción +$120.',
          en: 'Certified county clerk marriage certificates apostilled with expedited state filing for embassy or consular recognition. Regular 2-3 weeks ($150), fast ($550), express 24h ($700).',
        },
        requirements: {
          es: ['Documento original en físico indispensable', 'Acta certificada original emitida por el County Clerk', 'País receptor', 'Copia de identificación'],
          en: ['Physical original document required', 'Certified marriage certificate issued by county clerk', 'Country of destination', 'ID copy of petitioner'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
      ...
      },
      {
        ...
        shortDesc: {
          es: 'Legalización para trámites sucesorios, pensiones y repatriación de bienes. Regular 2 a 3 sem ($150).',
          en: 'Apostille for estate proceedings, overseas pensions, and foreign probate.',
        },
        fullDesc: {
          es: 'Apostilla expedita de actas de defunción para tramitar herencias internacionales, seguros o traslados en el exterior. Procesamiento regular en 2 a 3 semanas ($150), rápido en 1 semana ($550), express 24 horas ($700).',
          en: 'Apostille processing for certified death certificates used in foreign inheritance or insurance settlements. Regular 2-3 weeks ($150), fast ($550), express 24 hours ($700).',
        },
        requirements: {
          es: ['Documento original en físico indispensable', 'Certificado de defunción oficial certificado', 'Datos del país destino'],
          en: ['Physical original document required', 'Official certified death certificate', 'Target foreign jurisdiction'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
      ...
      },
      {
        ...
        shortDesc: {
          es: 'Validación internacional de poderes para compraventa, pleitos y cobranzas fuera de EE. UU. Regular 2 a 3 sem ($150).',
          en: 'International validation of POA documents for property sales and foreign legal representation.',
        },
        fullDesc: {
          es: 'Apostillamos poderes redactados en español o inglés que hayan sido notarizados correctamente conforme a la ley de Texas u otros estados. Opciones: Regular 2 a 3 semanas ($150), rápido 1 semana ($550) o express 24h ($700).',
          en: 'Complete apostille processing of general or special powers of attorney after compliant notarial execution. Standard 2-3 weeks ($150), fast ($550), express ($700).',
        },
        requirements: {
          es: ['Poder original en físico con certificación notarial vigente', 'Nombre del apoderado y poderdante', 'País de destino'],
          en: ['Physical original document with active notary acknowledgement', 'Grantor and agent details', 'Target country'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
        popular: true,
      ...
      },
      {
        ...
        fullDesc: {
          es: 'Certificación ante el Secretario de Estado de cualquier instrumento público autorizado por Notario Público debidamente acreditado. Trámite regular 2 a 3 semanas ($150), rápido ($550), express 24h ($700).',
          en: 'State verification and apostille attachment on any acknowledged or jurat notarial instrument. Standard 2-3 weeks ($150), fast ($550), express ($700).',
        },
        requirements: {
          es: ['Instrumento notarial original en físico', 'Sello y comisión notarial legible'],
          en: ['Original physical notarized instrument', 'Clear notary seal and commission expiration'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
      ...
      },
      {
        ...
        fullDesc: {
          es: 'Trámite indispensable para estudiar, convalidar carreras o ejercer profesionalmente en el extranjero. Coordinamos la certificación del registrador escolar (School Registrar) y la apostilla oficial. Regular 2 a 3 semanas ($150), rápido ($550), express ($700).',
          en: 'Essential for study abroad, professional licensure, or homologation. Regular 2-3 weeks ($150), fast ($550), express ($700).',
        },
        requirements: {
          es: ['Diploma o transcript original en físico sellado y notarizado', 'País donde se presentará'],
          en: ['Original physical diploma or transcripts notarized by registrar', 'Recipient country'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
      ...
      },
      {
        ...
        fullDesc: {
          es: 'Servicio local prioritario en Houston con conexión directa para entrega ante la Secretaría de Estado en Austin. Regular 2 a 3 semanas ($150), trámite rápido en 1 semana ($550), express en 24 horas ($700).',
          en: 'Priority Houston-based courier and processing with the Texas Secretary of State in Austin. Regular 2-3 weeks ($150), fast in 1 week ($550), express in 24 hours ($700).',
        },
        requirements: {
          es: ['Documento original físico emitido en el estado de Texas', 'Identificación oficial'],
          en: ['Original physical Texas state/county document', 'Client identification'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
        popular: true,
      },
      {
        ...
        fullDesc: {
          es: 'Canalizamos sus documentos ante las Secretarías de Estado correspondientes sin que usted tenga que viajar ni realizar trámites por correo. Regular 2 a 3 semanas ($150), rápido ($550), express ($700).',
          en: 'Turnkey routing through state capitals across the United States. Standard 2-3 weeks ($150), fast ($550), express ($700).',
        },
        requirements: {
          es: ['Documento original físico certificado del estado emisor', 'Especificar país receptor'],
          en: ['Original physical certified record from issuing state', 'Target country details'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
      },
      {
        ...
        shortDesc: {
          es: 'Solución integral: tramitamos la apostilla y traducimos con certificación oficial (+ $120).',
          en: 'End-to-end package combining official apostille and certified multilingual translation (+ $120).',
        },
        fullDesc: {
          es: 'Paquete de alta eficiencia que conecta el flujo de apostillado (regular $150, rápido $550, express $700) con la traducción jurada certificada (+ $120) requerida por embajadas y ministerios del país receptor.',
          en: 'Complete synchronized workflow ensuring state apostille (regular $150, fast $550, express $700) and certified translation (+ $120) are prepared flawlessly.',
        },
        requirements: {
          es: ['Documento original físico indispensable', 'Idioma de traducción requerido (Español/Inglés/Otros)'],
          en: ['Original physical document strictly required', 'Target language requirement (English/Spanish/Others)'],
        },
        estimatedDays: '2 a 3 semanas (Regular $150 | Rápido $550 | Express $700)',
        popular: true,
